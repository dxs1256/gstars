...
> Updated: 2026-09-14 21:49 UTC · Total: 135
...
> [!info]
> ⭐ 1,494 · HTML · 2026-09-23T19:48:16Z  
> [GitHub](https://github.com/tianma-if/edgeever) · [Website](https://edgeever.org)  
> `#AI智能体知识库` `#原生MCP` `#知识管理` `#跨平台` `#ai-agent` `#cloudflare` `#cloudflare-d1` `#cloudflare-r2` `#cloudflare-workers` `#docker` `#electron` `#evernote` `#evernote-alternative` `#knowledge-base` `#mcp` `#model-context-protocol` `#note-taking` `#offline-first` `#personal-knowledge-base` `#pwa` `#self-hosted` `#sqlite` `#tiptap` `#web-clipper` 
> EdgeEver 是开源 AI 原生知识库工具，可作为印象笔记替代方案，原生支持 MCP 协议实现 AI 智能体读写知识库，支持 Cloudflare 免费额度或 Docker 零成本部署，保留经典三栏布局，提供多端客户端，满足个人知识管理、高效笔记记录与 AI 辅助知识整理的场景需求。
...
> [!info]
> ⭐ 1,313 · Shell · 2026-09-23T18:14:51Z  
...
> [!info]
> ⭐ 1,937 · Rust · 2026-09-23T14:45:08Z  
...
> [!info]
> ⭐ 10,324 · N/A · 2026-09-23T13:55:26Z  
...
> [!info]
> ⭐ 33,688 · Fluent · 2026-09-23T20:40:28Z  
...
> [!info]
> ⭐ 73 · Dart · 2026-09-23T03:27:09Z  
> [GitHub](https://github.com/WEP-56/JAVBUS) · [Website](https://wep-56.github.io/JAVBUS/)  
> `#BT资源搜索` `#Flutter` `#声明式JSON插件` `#资源聚合工具` 
> JAVBUS是基于Flutter开发的跨平台资源聚合工具，采用声明式JSON插件架构实现BT种子搜索，无需编程即可编写分发插件，同时集成网盘搜索、链接收藏与局域网文件/文本互传功能，相比同类工具插件贡献门槛更低、跨平台兼容性更强。
...
> [!info]
> ⭐ 13,953 · JavaScript · 2026-09-23T19:56:19Z  
...
> `#xray+nginx反向代理` `#一键部署` `#反审查工具` `#argosbx` `#bypass` `#cloudflare` `#great-firewall` `#haproxy` `#nginx` `#psiphon` `#reverse-proxy` `#shadowsocks` `#tor` `#tunnel` `#v2raya` `#wireguard` `#wstunnel` `#x-ui` `#x-ui-pro` `#xray` `#xui` `#xui-pro` 
> XUI-PRO是面向Linux服务器的一键部署开源反审查工具，整合x-ui面板、nginx反向代理、Xray/V2Ray、WARP、Tor及Psiphon等多组件，支持多代理协议、Cloudflare CDN、自动SSL续期与反检测，提供一站式网络审查 bypass 方案。
...
> [!info]
> ⭐ 781 · JavaScript · 2026-09-23T18:30:04Z  
...
> [!info]
> ⭐ 456 · TypeScript · 2026-09-23T18:20:50Z  
...
> `#Cloudflare Workers` `#Hono.js` `#音乐数据同步` `#音乐服务` 
> 本项目是LX Music客户端的云同步服务Cloudflare Workers重构版，基于Hono.js与Durable Objects实现，无需自托管服务器即可支持多用户隔离、WebSocket实时同步歌单与偏好规则，支持快照合并冲突处理，可一键部署至Cloudflare边缘网络。
...
> [!info]
> ⭐ 153 · JavaScript · 2026-09-23T13:20:05Z  
...
> [!info]
> ⭐ 11,942 · JavaScript · 2026-09-23T17:52:23Z  
...
> [!info]
> ⭐ 314 · Shell · 2026-09-23T16:01:21Z  
...
> [!info]
> ⭐ 451 · Java · 2026-09-23T14:00:09Z  
> [GitHub](https://github.com/bi-box/Median)  
> `#原生Java开发` `#系统WebView` `#隐私浏览器` `#零数据收集` 
> Median是一款极致轻量化的Android本地优先隐私浏览器，安装包仅200KB，基于系统WebView用原生Java开发，无任何数据收集、遥测及第三方SDK，内置广告拦截、本地加密密码库、用户脚本、离线阅读等功能，主打隐私安全与高自由自定义。
...
> [!info]
> ⭐ 3,170 · Rust · 2026-09-23T15:49:10Z  
...
> [!info]
> ⭐ 14 · Python · 2026-09-23T15:09:17Z  
...
> [!info]
> ⭐ 422 · TypeScript · 2026-09-23T15:20:18Z  
...
> [!info]
> ⭐ 69,599 · TypeScript · 2026-09-23T21:28:37Z  
...
> `#AI智能体` `#SSH/SFTP终端` `#运维自动化` `#远程服务器运维` 
> CoShell是面向个人及可信网络的本地优先Windows桌面SSH/SFTP运维工作台，集成AI运维助手，支持多标签终端、文件管理、在线编辑，内置加密存储与本地搜索服务，无需外部依赖，可简化远程服务器运维流程。
...
> [!info]
> ⭐ 195 · TypeScript · 2026-09-23T09:57:33Z  
...
> `#SSH客户端` `#服务器运维` `#跨平台应用` `#运维自动化` `#ai` `#ai-assistant` `#android` `#cross-platform` `#devops` `#docker` `#file-manager` `#monitoring` `#port-forwarding` `#rust` `#self-hosted` `#server-management` `#ssh` `#ssh-client` `#sysadmin` `#tauri` `#terminal` `#tmux` `#vue` `#windows` 
> Creation-SSH（C-SSH）是原生跨平台SSH运维客户端，支持Windows/Android正式版与macOS测试版，提供持久化终端、SFTP文件管理、AI运维助手、加密云同步及细粒度权限管控，支持Agent与原生SSH双模式，覆盖日常运维、故障排查等全场景，满足多端一致的服务器运维需求。
...
> [!info]
> ⭐ 3,266 · TypeScript · 2026-09-23T16:43:17Z  
...
> [!info]
> ⭐ 5,714 · Shell · 2026-09-23T17:12:13Z  
...
> [!info]
> ⭐ 65 · Python · 2026-09-23T21:25:16Z  
...
> [!info]
> ⭐ 4,234 · JavaScript · 2026-09-23T17:50:37Z  
...
> `#AI Agent集成` `#Cloudflare Workers` `#D1+R2存储` `#博客系统` 
> 基于 Cloudflare Workers + D1 + R2 构建的轻量级博客系统，支持 MCP Server 对接 AI Agent，具备后台内容管理、R2 图片存储、安全加固、缓存性能优化、SEO 适配等能力，适合个人博客、轻量内容站点快速部署。
...
> `#AI摘要生成` `#GitHub Stars管理` `#开发者工具` `#自动化同步` 
> 本项目是面向开发者的GitHub Stars智能管理工具，自动抓取账号Star的全量仓库，调用AI生成内容摘要与技术标签，内置标签归一化机制避免标签爆炸，支持增量更新、并发AI处理，可自动同步至Obsidian与GitHub Pages，实现Stars的高效检索与归档。
...
> `#Xray-core` `#一键部署` `#网络代理管理` `#运维自动化` 
> 3x-ui是基于Xray-core的网页版代理/VPN控制面板二次开发分支，主打易用性：支持VPS一键自动安装、内置主流代理协议模板、中转分流、多服务器批量管理、扫码导入客户端，界面中文化优化，可快速完成各类代理协议的搭建与运维。

---
## MoonTechLab/Selene-TV

> [!info]
> ⭐ 845 · N/A · 2026-09-23T15:23:53Z  
...
> [!info]
> ⭐ 8,874 · N/A · 2026-09-23T21:19:07Z  
> [GitHub](https://github.com/igareck/vpn-configs-for-russia) · [Website](https://t.me/igareq)  
> `#多协议配置` `#封锁绕过` `#网络代理` `#自动化测试` `#free-vpn-key` `#free-vpn-russia` `#roskomnadzor` `#russia-vpn` `#shadowsocks` `#tor` `#tor-bridge` `#tor-bridges` `#tor-browser` `#tor-client` `#v2ray` `#vless` `#vpn` `#vpn-config` `#vpn-configuration` `#vpn-for-russia` `#vpn-free-russia` `#vpn-russia` `#whitelist` `#xray` 
...
> [!info]
> ⭐ 6,134 · JavaScript · 2026-09-23T20:30:47Z  
...
> `#桌面应用` `#社交平台媒体采集` `#网页爬虫` 
> X平台媒体批量下载工具，支持多博主一键下载、文件去重、日期范围过滤、自定义存储路径与文件名，适配代理、Cookie登录，现由新维护者接手并以AI辅助模式持续迭代。
...
> [!info]
> ⭐ 865 · JavaScript · 2026-09-23T13:05:31Z  
...
> K-Vault是基于Cloudflare Serverless架构的免费聚合云盘，支持Telegram、R2、S3、Discord等多存储后端，提供Cloudflare Pages与Docker双模部署，具备分片上传、内容审核、WebDAV访问等能力，可零成本搭建私有文件托管与数据存储方案。
...
> `#Aria2 Rclone` `#Telegram Bot` `#下载云同步管理` `#自动化工具` 
> MistRelay是基于Telegram机器人的aria2下载控制系统，集成OneDrive自动上传、文件直链生成能力，支持多级数据校验、Docker一键部署及跨平台桌面客户端，实现远程下载、云同步、文件分享的全流程自动化，适用于个人/团队离线资源管理场景。
> <sub>自动化下载上传</sub>
...
> [!info]
> ⭐ 85,081 · Python · 2026-09-23T21:01:03Z  
...
> [!info]
> ⭐ 3,756 · TypeScript · 2026-09-23T18:23:27Z  
...
> [!info]
> ⭐ 1,290 · Rust · 2026-09-23T14:23:31Z  
...
> `#OpenWrt设备监控` `#多平台推送` `#运维自动化` 
> 本插件是OpenWrt路由器的LuCI消息推送工具，基于原Serverchan插件改造，解决微信推送无法区分聊天与功能消息、内容需二次查看等缺陷，支持钉钉/企微/飞书/Bark等10+推送渠道，可监控设备上下线、路由状态、流量等数据，满足软路由运维通知需求。
...
> `#GPUI` `#Rust` `#桌面应用` `#视频下载` 
> MageKit是基于Rust与GPUI框架开发的跨平台桌面视频下载工具，以yt-dlp为核心下载引擎，支持多平台视频下载、并发任务管理、主题切换、元数据嵌入等功能，提供GPU加速的流畅界面与全平台安装包，可满足用户多场景视频获取需求。
...
> `#LuatOS开发` `#多渠道短信转发` `#物联网应用` 
> 本项目是基于LuatOS开发的Air780E物联网设备智能短信转发系统，支持关键词与正则匹配筛选短信，可转发至企业微信、飞书、钉钉、自定义Webhook及邮件等多渠道，具备异步并发、网络容错、低功耗运行特性，适用于重要短信自动同步、验证码统一通知等场景。
...
> `#.NET Core` `#Vue` `#媒体同步工具` `#抖音内容同步` 
> dysync.net 是基于 .NET Core 与 Vue 开发的抖音内容同步工具，支持多账号同步抖音收藏夹、「我喜欢」视频及指定博主作品，内置视频信息刮削功能，可对接 Emby/Jellyfin 媒体库直接播放，支持 Docker 部署，实现抖音内容的本地备份与媒体库整合。
> <sub>视频同步工具</sub>
...
> `#Cloudflare Workers` `#Vue3` `#服务续费管理` `#运维自动化` `#icalendar` `#notify` `#renew` `#subscribe` 
> RenewHelper（时序·守望）是基于Cloudflare Workers的零成本全栈服务生命周期管理工具，专为周期性订阅、域名/服务器续费提醒等场景设计，支持农历/公历周期计算、多渠道通知、iCal同步、账单管理，提供机甲风UI，支持Worker与Docker双部署。
...
> `#Lua脚本` `#串口通信` `#物联网应用` `#短信转发` 
> 基于合宙Air780系列物联网模组的短信UART转发系统，通过串口将短信、来电信息同步至上位机，支持钉钉/企微/飞书等多平台消息推送、短信收发与定时发送任务，提供Docker/原生部署方式及Web管理界面，可快速搭建物联网短信中转服务。
...
> [!info]
> ⭐ 55,188 · N/A · 2026-09-23T19:02:41Z  
...
> [!info]
> ⭐ 5,815 · Shell · 2026-09-23T15:20:35Z  
...
> [!info]
> ⭐ 15,577 · N/A · 2026-09-23T17:23:03Z  
...
> [!info]
> ⭐ 23,539 · JavaScript · 2026-09-23T20:43:02Z  
...
> `#EXIF元数据解析` `#Go语言` `#多媒体文件重命名` `#自动化工具` 
> go-rename 是基于 Go 开发的跨平台照片视频重命名工具，解决多设备拍摄文件重名、难整理的核心痛点，支持按 EXIF 拍摄时间、文件时间戳或 MD5 值重命名，自动处理重名文件，支持全架构多系统部署。
...
> [!info]
> ⭐ 47,960 · N/A · 2026-09-23T20:05:49Z  
...
> [!info]
> ⭐ 14,679 · Go · 2026-09-23T18:25:29Z  
...
> [!info]
> ⭐ 14,467 · Python · 2026-09-23T20:22:12Z  
...
> `#Java` `#容器化` `#智能家居` `#智能音箱改造` 
> 这个项目是针对斐讯R1智能音箱的IoT改造开源方案，基于Java开发，提供Docker一键部署能力，支持自定义访问密码与配置持久化，可将闲置R1音箱接入智能家居生态，同时配套闲鱼二手设备交易入口。
...
> [!info]
> ⭐ 193,202 · Python · 2026-09-23T21:25:40Z  
...
> `#Go语言` `#代理池` `#安全测试辅助` `#网络安全` 
> Deadpool是Go开发的代理池工具，面向合法授权的安全测试与攻防演练场景，支持从hunter、quake、fofa等网络空间测绘平台批量获取高质量socks5代理，也可本地导入，内置存活校验、轮询转发、优雅退出等能力，可对接Burp、Proxifier等工具使用。
...
> [!info]
> ⭐ 4,068 · TypeScript · 2026-09-23T19:27:48Z  
> [GitHub](https://github.com/imsyy/DailyHotApi)  
> `#RESTful API` `#RSS订阅` `#热榜数据聚合` `#网页爬虫` `#api` `#daily-hot` `#list` `#rss` `#vercel` 
> 聚合B站、微博、知乎、抖音等平台热门榜单的统一API接口，支持JSON/RSS双模式返回，提供Vercel、Docker等多方式部署，响应速度快，可集成到各类应用中，解决多平台热榜数据采集与统一调用需求。
...
> [!info]
> ⭐ 5,826 · N/A · 2026-09-23T18:46:40Z  
...
> [!info]
> ⭐ 589 · JavaScript · 2026-09-23T18:33:22Z  
...
> [!info]
> ⭐ 18,402 · TypeScript · 2026-09-23T15:55:59Z  
...
> [!info]
> ⭐ 11,461 · Kotlin · 2026-09-23T20:35:45Z  
...
> [!info]
> ⭐ 5,917 · JavaScript · 2026-09-23T19:44:01Z  
...
> [!info]
> ⭐ 20,306 · Python · 2026-09-23T19:43:10Z  
...
> [!info]
> ⭐ 13,506 · TypeScript · 2026-09-23T19:14:12Z  
...
> [!info]
> ⭐ 11,338 · Java · 2026-09-23T16:46:32Z  
...
> [!info]
> ⭐ 25,277 · Python · 2026-09-23T15:20:55Z  
...
> [!info]
> ⭐ 16,249 · JavaScript · 2026-09-23T16:03:45Z  
...
> [!info]
> ⭐ 1,552 · Python · 2026-09-22T01:28:14Z  
...
> [!info]
> ⭐ 3,517 · Python · 2026-09-23T21:08:05Z  
...
> [!info]
> ⭐ 11,431 · JavaScript · 2026-09-23T17:09:38Z  
...
> [!info]
> ⭐ 3,317 · Java · 2026-09-23T18:38:48Z  
...
> `#SSL证书自动续期` `#Shell脚本` `#运维自动化` `#nginx` `#ssl` `#ssl-certificate` `#ssl-certificates` `#ssl-support` `#tls` `#tls-certificate` 
> httpsok是一款轻量SSL证书自动续期工具，仅需一行命令即可完成部署，支持Nginx/Apache等服务器、泛域名/多域名证书管理，兼容主流Linux与Docker环境，可对接阿里云、腾讯云等云厂商CDN/OSS服务，还提供证书到期提醒，替代传统Let's Encrypt手动续签流程。
...
> [!info]
> ⭐ 15,442 · N/A · 2026-09-23T21:29:52Z  
...
> [!info]
> ⭐ 13,995 · Dart · 2026-09-23T18:53:29Z  
...
> [!info]
> ⭐ 1,907 · Python · 2026-09-23T16:32:15Z  
...
> [!info]
> ⭐ 77 · JavaScript · 2026-09-23T15:34:19Z  
...
> [!info]
> ⭐ 7,591 · Python · 2026-09-23T19:51:22Z  
...
> [!info]
> ⭐ 4,054 · Shell · 2026-09-23T13:30:26Z  
...
> [!info]
> ⭐ 9,244 · TypeScript · 2026-09-23T13:01:59Z  
...
> [!info]
> ⭐ 5,440 · Rust · 2026-09-23T16:29:55Z  
...
> [!info]
> ⭐ 850 · TypeScript · 2026-09-22T17:54:03Z  
...
> [!info]
> ⭐ 37,009 · Go · 2026-09-23T18:51:23Z  
> [GitHub](https://github.com/1Panel-dev/1Panel) · [Website](https://1panel.pro)  
> `#AI管理平台` `#可视化运维` `#服务器管理` `#运维自动化` `#agent` `#deepseek-harness` `#docker` `#docker-ui` `#hermes` `#hermes-agent` `#linux` `#lnmp` `#ollama` `#openclaw` `#openresty` `#qwenpaw` `#webmin` 
...
> [!info]
> ⭐ 10,776 · N/A · 2026-09-23T17:57:16Z  
...
> [!info]
> ⭐ 34,063 · Java · 2026-09-23T20:13:17Z  
...
> [!info]
> ⭐ 24,407 · N/A · 2026-09-23T16:06:08Z  
...
> [!info]
> ⭐ 34,492 · Python · 2026-09-23T21:13:18Z  
...
> [!info]
> ⭐ 16,267 · N/A · 2026-09-23T13:52:57Z  
...
> `#Docker部署` `#RSS变动监测` `#RSS订阅工具` `#多渠道消息推送` `#apprise` `#docker` `#docker-compose` `#rss` `#rsshub` `#serverchan` 
> RSSPush是一款开源RSS变动监测Web应用，可将RSS更新自动推送至微信、Telegram、Discord等数十个消息通道，内置RSSHub提供两千余个订阅源，支持Docker一键部署、HTTP代理、关键词过滤及AI自动翻译，适用于个人订阅聚合、信息监控等场景。
...
> `#变更监测` `#多通知推送` `#网页爬虫` `#网页监控` `#monitor` `#rss` `#web-monitor` 
> WebMonitor 是一款开源的网页变更实时监控工具，支持静态/动态网页抓取，可通过 XPath、CSS 选择器及 JsonPath 提取目标数据，覆盖邮件、Telegram 等 7+ 通知渠道，提供可视化操作界面，支持 Docker 部署与自定义规则，适用于信息追踪、竞品监控等场景。
...
> [!info]
> ⭐ 32,149 · N/A · 2026-09-23T19:46:07Z  
...
> [!info]
> ⭐ 1,375 · Dockerfile · 2026-09-20T19:57:18Z  
> [GitHub](https://github.com/hongyonghan/Docker_Microsoft365_E5_Renew_X)  
> `#容器化` `#订阅续订` `#跨平台` `#运维自动化` 
> 本项目是Microsoft 365 E5订阅API续订服务的Docker容器化版本，基于开源项目二次开发，支持多CPU架构部署，镜像轻量、部署简单，内置邮件通知、运行监控功能，仅可用于学习用途，禁止商业化。
...
> [!info]
> ⭐ 53,875 · TypeScript · 2026-09-23T19:14:52Z  
...
> `#Heroku部署` `#V2Ray` `#网络代理` `#轻量代理搭建` `#v2ray-heroku` `#websocket-v2ray` 
> 本仓库提供Heroku平台一键部署V2Ray WebSocket的自动化方案，支持自动更新V2Ray至最新版本，可对接Cloudflare提升访问速度，另提供VLESS协议分支，合理使用可避免资源占用导致的封号，适用于轻量代理服务快速搭建场景。
...
> [!info]
> ⭐ 25,828 · JavaScript · 2026-09-23T11:49:13Z  
